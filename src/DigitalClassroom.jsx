    ...
    <div className="classroom-page">
      <div className="classroom-left-section" ref={leftSectionRef}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
          <h2 className="whiteboard-heading" style={{ marginBottom: 0 }}>Whiteboard Development Sandbox</h2>
          <button
            onClick={addWhiteboard}
            style={{ padding: '8px 16px', backgroundColor: '#2166c4', color: '#fff', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold' }}
          >
            + New Whiteboard
          </button>
        </div>
        ...
        {whiteboards.map(function (id) {
          return (
            <div key={id} className="whiteboard-wrapper" style={{ marginBottom: '20px', minHeight: '600px', flex: 'none' }}>
              <Whiteboard id={id} />
            </div>
          );
        })}
