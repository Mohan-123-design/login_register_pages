    ...
    <div className="register-page">
      ...
      <div className="register-right-section">
        <div className="register-card">
          ...
          <p className="register-subtitle-text">Please fill in the details to register</p>
          <div id="success-message" className="register-success-message" style={{ display: 'none' }}></div>
          <form onSubmit={handleRegister}>
            <div className="register-name-row">
              <div className="register-form-group">
                <label htmlFor="first-name-input">First Name</label>
                <input type="text" id="first-name-input" placeholder="First name" />
                <p id="first-name-error" className="register-error-message" style={{ display: 'none' }}></p>
              </div>
              <div className="register-form-group">
                <label htmlFor="last-name-input">Last Name</label>
                <input type="text" id="last-name-input" placeholder="Last name" />
                <p id="last-name-error" className="register-error-message" style={{ display: 'none' }}></p>
              </div>
            </div>
            <div className="register-form-group">
              <label htmlFor="register-email-input">Email Address</label>
              <input type="email" id="register-email-input" placeholder="Enter your email" />
              <p id="email-error" className="register-error-message" style={{ display: 'none' }}></p>
            </div>
            <div className="register-form-group">
              ...
              <div className="register-password-wrapper">
                ...
                />
                <button type="button" id="toggle-pass-btn" onClick={togglePassword} className="register-toggle-password-btn" >🔒</button>
              </div>
              <p id="password-error" className="register-error-message" style={{ display: 'none' }}></p>
              <div id="strength-container" className="register-strength-container" style={{ display: 'none' }}>
                <div className="register-strength-bar-background">
                  <div id="strength-bar-fill" className="register-strength-bar-fill" style={{ width: '0%' }}></div>
                </div>
            ...
            <div className="register-form-group">
              ...
              <div className="register-password-wrapper">
                ...
                <button type="button" id="toggle-confirm-btn" className="register-toggle-password-btn" onClick={toggleConfirmPassword} >🔒</button>
              </div>
              <p id="confirm-password-error" className="register-error-message" style={{ display: 'none' }}></p>
            </div>
